...
Polymer {
  ...
  properties:
    ...
    survey1ChoiceList:
      type: Array
      value: -> ['Kazi', 'Social Media', 'Mobile Message', 'Website', 'Social Gathering', 'Newspaper Article', 'TV Program', 'BADAS / Birdem Center']
  ...
  _savePccRecord: (data)->
    ...
    app.db.upsert 'pcc-records', data, ({serial})=> data.serial is serial
  ...
  getComputedData: ()->
    data =
      ...
      hbStatus: @hbStatus
      albuminType: @albuminType
      urinePusCellStatus: @urinePusCellStatus
      hBsAgStatus: @hBsAgStatus
      vdrlStatus: @vdrlStatus
