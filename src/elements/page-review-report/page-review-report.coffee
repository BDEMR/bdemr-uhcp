Polymer {
  ...
  _updateTestResults: ()->
    data = {
      apiKey: @user.apiKey
      serial: @reviewReport.serial
      availableToPatient: @reviewReport.availableToPatient
      flagAsError: @reviewReport.data.flags.flagAsError
      seenByAdvisedDoctor: @reviewReport.data.flags.seenByAdvisedDoctor
    }
